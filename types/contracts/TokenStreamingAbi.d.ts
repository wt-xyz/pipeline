...
export enum ErrorInput { NonExistentStream = 'NonExistentStream', InvalidDates = 'InvalidDates', DateTooEarly = 'DateTooEarly', SelfAddress = 'SelfAddress', ZeroAddress = 'ZeroAddress', ZeroDeposit = 'ZeroDeposit', StreamDoesNotExist = 'StreamDoesNotExist', VaultDoesNotExist = 'VaultDoesNotExist', NotReceiver = 'NotReceiver', InsufficientBalance = 'InsufficientBalance', InsufficientShares = 'InsufficientShares', StreamAlreadyCancelled = 'StreamAlreadyCancelled', NotSender = 'NotSender', NotEnoughCoins = 'NotEnoughCoins', DepositsBlocked = 'DepositsBlocked', InvalidAsset = 'InvalidAsset', IncorrectDeposit = 'IncorrectDeposit', NotCancellable = 'NotCancellable' };
export enum ErrorOutput { NonExistentStream = 'NonExistentStream', InvalidDates = 'InvalidDates', DateTooEarly = 'DateTooEarly', SelfAddress = 'SelfAddress', ZeroAddress = 'ZeroAddress', ZeroDeposit = 'ZeroDeposit', StreamDoesNotExist = 'StreamDoesNotExist', VaultDoesNotExist = 'VaultDoesNotExist', NotReceiver = 'NotReceiver', InsufficientBalance = 'InsufficientBalance', InsufficientShares = 'InsufficientShares', StreamAlreadyCancelled = 'StreamAlreadyCancelled', NotSender = 'NotSender', NotEnoughCoins = 'NotEnoughCoins', DepositsBlocked = 'DepositsBlocked', InvalidAsset = 'InvalidAsset', IncorrectDeposit = 'IncorrectDeposit', NotCancellable = 'NotCancellable' };
...
export type StreamInput = { deposit: BigNumberish, rate_per_second_e_10: BigNumberish, stream_size: BigNumberish, vested_withdrawn_amount: BigNumberish, start_time: BigNumberish, stop_time: BigNumberish, underlying_asset: AssetIdInput, receiver_asset: AssetIdInput, sender_asset: AssetIdInput, cancellation_time: Option<BigNumberish>, configuration: StreamConfigurationInput };
export type StreamOutput = { deposit: BN, rate_per_second_e_10: BN, stream_size: BN, vested_withdrawn_amount: BN, start_time: BN, stop_time: BN, underlying_asset: AssetIdOutput, receiver_asset: AssetIdOutput, sender_asset: AssetIdOutput, cancellation_time: Option<BN>, configuration: StreamConfigurationOutput };
export type StreamConfigurationInput = { is_cancellable: boolean, is_undercollateralized: boolean };
...
interface TokenStreamingAbiInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'cancel_stream', values: [IdentityInput]): Uint8Array;
  encodeFunctionData(functionFragment: 'create_stream', values: [IdentityInput, IdentityInput, BigNumberish, BigNumberish, BigNumberish, StreamConfigurationInput]): Uint8Array;
  encodeFunctionData(functionFragment: 'get_stream', values: [BigNumberish]): Uint8Array;
  encodeFunctionData(functionFragment: 'get_stream_by_vault_share_id', values: [AssetIdInput]): Uint8Array;
  encodeFunctionData(functionFragment: 'get_vault_info', values: [AssetIdInput]): Uint8Array;
  ...
  encodeFunctionData(functionFragment: 'deposit', values: [IdentityInput, string]): Uint8Array;
  encodeFunctionData(functionFragment: 'managed_assets', values: [AssetIdInput, string]): Uint8Array;
  encodeFunctionData(functionFragment: 'max_depositable', values: [IdentityInput, AssetIdInput, string]): Uint8Array;
  encodeFunctionData(functionFragment: 'max_withdrawable', values: [AssetIdInput, string]): Uint8Array;
  encodeFunctionData(functionFragment: 'withdraw', values: [IdentityInput, AssetIdInput, string]): Uint8Array;

  decodeFunctionData(functionFragment: 'cancel_stream', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'create_stream', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'get_stream', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'get_stream_by_vault_share_id', data: BytesLike): DecodedValue;
  ...
  decodeFunctionData(functionFragment: 'managed_assets', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'max_depositable', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'max_withdrawable', data: BytesLike): DecodedValue;
